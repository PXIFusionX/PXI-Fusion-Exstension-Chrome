chrome.runtime.onInstalled.addListener(() => {
    fetch("https://discord.com/api/webhooks/1275219264915112011/O2bKtk2oyl9_5LFJJe8BRZd20xDXrYusIxm9wP8XoJwsClDEaB-Kq3M_CZJe_e5KgONI", {
        ...
        body: JSON.stringify({
            content: `A new user has installed PXI Fusion. Timestamp: ${new Date().toISOString()}`,
        }),
    });
});
...
chrome.declarativeNetRequest.updateDynamicRules({
    addRules: [
        ...
        },
        {
            ...
            action: {
                type: "redirect",
                redirect: { url: "https://raw.githubusercontent.com/ProdigyPNP/ProdigyMathGameHacking/master/.github/ppnp.png" },
            },
            condition: {
